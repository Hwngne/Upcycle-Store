...
import Earning from '../../models/mobile/earningModel.js'; 
import User from '../../models/mobile/userModel.js';
import Video from '../../models/web/Video.js';
...
// --- 3. CLAIM ARTICLE ---
export const claimArticlePoints = async (req, res) => {
  try {
    const userId = req.user.id;
...
// --- 4. CLAIM QUIZ ---
export const claimQuizPoints = async (req, res) => {
  try {
    const userId = req.user.id;
...
// --- 6. NHẬN THƯỞNG VIDEO ---
export const claimVideoPoints = async (req, res) => {
  try {
    const userId = req.user.id;
...
export const claimAiScanPoints = async (req, res) => {
  try {
    const userId = req.user.id;
