...
const CreateArticleModal = ({ isOpen, onClose, onSubmit }) => {
        ...
        >
            ...
            >
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-bold text-[#4B0503]">Tạo bài báo mới</h3>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <CustomDropdown
                        ...
                        value={displayType}
                        //value={displayType === "home" ? "Trang chủ (Home)" : "Săn điểm (Hunt)"}
                    ...
                    {/* Trạng thái - dùng cùng component, thêm isGradient */}
                    <CustomDropdown
                        refProp={statusRef}
                        open={statusOpen}
                        setOpen={setStatusOpen}
                        value={status}   // ← QUAN TRỌNG
                        onChange={setStatus}
                    ...
                    <div className="flex justify-end gap-4 pt-6">
                        ...
                        >
                            {isSubmitting ? "Đang tạo..." : "Tạo bài báo"}
                        </button>
                    </div>
                </form>
            </div>
