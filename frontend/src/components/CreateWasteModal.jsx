...
const CreateWasteModal = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSubmit = () => {
        if (!formData.name) return alert("Tên loại rác không được để trống");
        onSubmit(formData);
        onClose();
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={onClose}>
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-bold text-[#4B0503]">Thêm Loại Rác</h3>
                    <button
                        onClick={onClose}
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-sm mb-1 text-[#4B0503]">Tên loại rác</label>
                        <input
                            name="name"
                            value={formData.name}
                    ...
                    <div>
                        <label className="block text-sm mb-1 text-[#4B0503]">Mô tả</label>
                        <input
                            name="description"
